	...
	if(!$resulttrees || !$resultgarden)
	...
	else
		{
			if(mysqli_num_rows($resulttrees) > 0)
			{
				...
				{
					echo "<tr><td>",$row["treename"],"</td><td>",$row["treetype"],"</td><td>",$row["treedesc"],"</td><td><a href='item.php?id=<?php echo $row['treeid'];?>'>Buy</a></td></tr>";
				}
				echo "</table>";
			...
			if(mysqli_num_rows($resultgarden) > 0)
			{
				...
				{
					echo "<tr><td>",$row["productname"],"</td><td>",$row["productdesc"],"</td><td><a href='item.php?id=<?php echo $row['productid'];?>'>Buy</a></td></tr>";
				}
				echo "</table>";
			}
		}
